...
const char PROGMEM HTML_PART_4[] = R"====(" alt="" />
        ...
        <script src="https://cloud.fiaos.org/fiaphy/javascript/device-uploader.js" defer onerror="console.log('Offline: Uploader skipped')"></script>
